...
Memo: At first should use X-Y, and then add Z axis
Memo: O: Ordubal, Q: Quantitative, !=: Nominal
Memo: Only operation you can do to Nominal is =/!=, not >/<
...
Memo: Not right/wrong answer. Waste of space, and just want to show downward slope? Or want to show large variance in fertility?
