...
Memo: Vega knows 4 types of data
...
* recap
    ...
    * With *ratio* data can also ask:
    ...
    Memo: There's no meaning of discussing "=0" for Ordinal? (though we can calc)
...
* Discussion question -- Why is it so important to include zeros for ratio data? Can you give a counter-example where omitting zeros on the plot would lead the reader to misleading conclusions? 
    ...
    Memo: See the after_lecture file! The graph deceives us as if the changing rate is quite steeper than how it looks like in real.  
