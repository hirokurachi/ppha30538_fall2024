...
Memo: q1 = 25th percentile, q3 = 75th percentile
Memo: Be careful that a row represents not a individual movie, but an aggregated set of movies in a genre. Thus the implication is such as that some Dramas are as nice as some Documentaries, but some are not.
...
Memo: a bug; there are values for future release date!
...
Memo: Simplicity v. Understandability on what's going on.
